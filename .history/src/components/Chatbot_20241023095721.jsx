...
const Chatbot = () => {
  ...
  const portfolioInfo = {
    name: "Juan Cuzcano",
    experience: "year working as a Desktop Suppport Technican",
    education: "a Bachelor's Degree of Science in Information Technology.",
  ...
  const sendMessage = async () => {
    ...
    if (input.toLowerCase().includes('name')) {
      botResponse = `Your name is ${portfolioInfo.name}.`;
