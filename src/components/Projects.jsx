...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      title: "Project 3",
      type: { title: "Hardware" },
      content: "Led a campus-wide deployment of lab computers, which involved registering and configuring the devices with the appropriate images for student, faculty, and staff use.",
